...
def generate_launch_description():
    ...
    primary_lidar_enable = EnvironmentVariable('JACKAL_LASER', default_value='true')
    primary_lidar_model = EnvironmentVariable('JACKAL_LASER_MODEL', default_value='ust10')
    primary_lidar_ip = EnvironmentVariable('JACKAL_LASER_HOST', default_value='192.168.0.10')
